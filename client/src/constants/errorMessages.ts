export const ERROR_CODE_TRANSLATIONS = {
  ...
  'password-not-set': 'errors.passwordNotSet',
  ...
  'p2p-profile-not-found': 'errors.p2pProfileNotFound',
  'p2p-order-in-progress': 'errors.p2pOrderInProgress',
  'p2p-trading-banned': 'errors.p2pTradingBanned',
