...
//
// export function pushAuditLog<T extends ACTIVITY_TYPE>(
//   entry: AuditLogEntry<T>,
// ): Promise<string> {
//   return auditLogService.push(entry);
// }
//
// export function pushAuditLogBatch<T extends ACTIVITY_TYPE>(
//   entries: AuditLogEntry<T>[],
// ): Promise<string[]> {
//   return auditLogService.pushBatch(entries);
// }
